...
var DayTable = /** @class */ (function () {
    ...
    DayTable.prototype.sliceRange = function (range) {
        var segs = [];
        var firstMonthStart = moment__WEBPACK_IMPORTED_MODULE_0___default()(range.start).startOf('month');
        var currentMonthStart = moment__WEBPACK_IMPORTED_MODULE_0___default()(range.start).startOf('month');
        var currentMonthEnd = moment__WEBPACK_IMPORTED_MODULE_0___default()(range.start).endOf('month');
        var lastMonthStart = moment__WEBPACK_IMPORTED_MODULE_0___default()(range.end).startOf('month');
